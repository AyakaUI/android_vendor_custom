...
def is_ayakaui_gerrit(remote_url):
    p = urllib.parse.urlparse(remote_url)
    return p.hostname == "review.ayakaui.net"
...
def main():
    ...
    parser.add_argument(
        "-g",
        "--gerrit",
        default="https://review.ayakaui.net",
        metavar="",
...
def do_git_fetch_pull(args, item):
    ...
    if is_lineage_gerrit(args.gerrit) or is_ayakaui_gerrit(args.gerrit):
        if args.verbose:
